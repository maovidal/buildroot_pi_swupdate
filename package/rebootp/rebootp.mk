...
REBOOTP_VERSION = 1.0
REBOOTP_SITE = $(BR2_EXTERNAL_PISWU_CFG_PATH)/package/rebootp
...
define REBOOTP_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -m 0755 $(BR2_EXTERNAL_PISWU_CFG_PATH)/package/rebootp/rebootp.sh $(TARGET_DIR)/usr/bin/rebootp.sh
endef
