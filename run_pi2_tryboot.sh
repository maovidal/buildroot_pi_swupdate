...
OUTPUT_DIR=/workspace/outputs/pi_swupdate/pi2_tryboot
CCACHE_LIMIT="50G"
...
DOCKER_RUN="docker run
    ...
    -v $(pwd)/images/pi_swupdate/pi2_tryboot:$OUTPUT_DIR/images
    -v $(pwd)/target/pi_swupdate/pi2_tryboot:$OUTPUT_DIR/target
    -v $(pwd)/graphs/pi_swupdate/pi2_tryboot:$OUTPUT_DIR/graphs
